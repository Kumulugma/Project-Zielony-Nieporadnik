<div class="wrap" id="configuration-page">
    ...
    <div class="card" style="max-width: none;">
        <form method="post" action="admin.php?page=placeholder">
            <fieldset>
                <p>
                    <label for="placeholderActivate">Uruchom zaślepkę: </label>
                ...
                <?php if (K3ePlaceholder::getStatus()) { ?>
                    <p>
                        <small>Shortcode do umieszczenia na stronie: <input type='text' value='[K3E_PLACEHOLDER]'/></small>
                    </p>
                    <hr>
                    <p>
                        <label for="placeholderTitle">Tytuł zaślepki: </label>
                        <input type="text" id="placeholderTitle" name="Placeholder[name]" value="<?= K3ePlaceholder::getName() ?>">
                    </p>
                    <p>
                        <label for="placeholderNumber">Ilość zakładek:</label>
                    ...
                    <?php for ($amount = 0; $amount < K3ePlaceholder::getAmount(); $amount++) { ?>
                        ...
                        <p> 
                            ...
                            <label for="PlaceholderActive_<?= $amount ?>">Status: <?= (isset($placeholders[$amount]['active']) && $placeholders[$amount]['active'] ? "Tak" : "Nie") ?></label>

                            <br>
                            <label for="PlaceholderHeadling_<?= $amount ?>">Nagłówek:</label>
                            ...
                            <br>
                            <label for="PlaceholderContent_<?= $amount ?>">Treść:</label>
